    ...
    <section id={id} className="relative overflow-hidden bg-[#060B09] text-white">
      ...
      <div className="relative mx-auto max-w-7xl px-6 py-24">
        ...
        >
            ...
            <a href={process.env.NEXT_PUBLIC_WHITEPAPER_URL || "https://sagenex-academy-videos.s3.ap-south-1.amazonaws.com/whitepaper/Sagenex+2026.pdf"} target="_blank" rel="noopener noreferrer">
