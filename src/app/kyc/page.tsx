...
export default function KycPage() {
    ...
    const [faceModalDocType, setFaceModalDocType] = useState<string | null>(null);
                ...
                <div className="max-w-4xl mt-16 mx-auto">
                    ...
                    <div className="bg-gray-900/40 border border-gray-800 rounded-xl p-4 sm:p-5 mb-4 sm:mb-6">
                        ...
                        <div className="w-full bg-gray-700 rounded-full h-3 overflow-hidden">
                            <div className="bg-linear-to-r from-emerald-500 to-green-600 h-full transition-all duration-500 ease-out flex items-center justify-end pr-1" style={{ width: `${progressPercentage}%` }}>
                                            ...
                                            <div className="flex flex-col gap-3">
                                                <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                                                    ...
                                                    <div className="flex flex-wrap items-center gap-2 sm:justify-end">
                                                        {faceRequired && (
                                                            <span
                                                                className={`rounded-full border px-3 py-1 text-xs font-semibold ${faceVerificationId
                                                                ...
                                                                {slot.mode === "file" ? (
                                                                    ...
                                                                    <Button
                                                                        ...
                                                                        onClick={() => {
                                                                            ...
                                                                            if (nextDoc && faceRequired && !faceVerificationId) {
                                                                                stopCaptureCamera();
                                                                                setFaceModalDocType(nextDoc);
                                                                ...
                                                                {faceVerificationId ? (
                                                                    ...
                                                                    <div className="flex flex-col gap-2">
                                                                        <div className="text-xs text-emerald-200">
                                                                            Face verification required before capturing this ID.
                                                                        </div>
                                                                        <Button
                                                                            type="button"
                                                                            className="w-full bg-emerald-600 text-white hover:bg-emerald-500 sm:w-auto"
                                                                            onClick={() => {
                                                                                setFaceModalDocType(slot.docType);
                                                                                setFaceModalOpen(true);
                                                                            }}
                                                                        >
                                                                            Verify Face Now
                        ...
                        <DialogContent className="bg-gray-950 border-gray-800 p-4 sm:p-6 sm:max-w-2xl max-h-[90vh] overflow-y-auto">
                            {faceModalDocType && (
                                <FaceVerificationPanel
                                    ...
                                    onVerified={(passed) => {
                                        setFaceVerifiedDoc(passed ? faceModalDocType : null);
                                        if (passed) {
                                    ...
                                    onVerificationToken={(token) =>
                                        setFaceVerificationMap((prev) => ({
                                            ...prev,
                                            [faceModalDocType]: token?.verificationId ?? "",
                                        }))
                                    }
                                />
                            )}
